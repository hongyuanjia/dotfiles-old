...
syn region debcontrolStrictField matchgroup=debcontrolKey start="^Package: *" end="$" contains=debcontrolName oneline
syn region debcontrolStrictField matchgroup=debcontrolKey start="^Title: *" end="$" contains=debcontrolPriority oneline
...
let b:current_syntax = 'r_description'
